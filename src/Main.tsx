        ...
        >
          ...
          <div className="bg-slate-900/80 backdrop-blur-xl p-8 rounded-[2.5rem] border border-slate-800 shadow-2xl">
            ...
            <button 
              ...
              className="w-full bg-white text-slate-900 py-4 rounded-2xl font-bold text-base hover:bg-slate-100 active:scale-[0.98] transition-all flex items-center justify-center gap-3 shadow-lg"
            >
